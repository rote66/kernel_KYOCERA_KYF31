...
unsigned int prev_freq_step_slp;
unsigned int prev_sampling_rate_slp;
static void __maybe_unused cpufreq_pegasusq_early_suspend(struct power_suspend *h)
{
#if EARLYSUSPEND_HOTPLUGLOCK
...
static void __maybe_unused cpufreq_pegasusq_late_resume(struct power_suspend *h)
{
#if EARLYSUSPEND_HOTPLUGLOCK
